...
if _currenthit = 3{
	draw_sprite_ext(spr_fight_aim[3],0,_aim_x4,y,_aim_scale4,_aim_scale4,0,_aim_color4,_aim_alpha4);
}else{
	draw_sprite_ext(spr_fight_aim[3],1,_aim_x4,y,_aim_scale4,_aim_scale4,0,_aim_color4,_aim_alpha4);
