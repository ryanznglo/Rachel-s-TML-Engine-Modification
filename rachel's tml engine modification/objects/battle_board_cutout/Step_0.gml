...
if(enable_frame){
	//上
	_point_x=x-left-battle_board.thickness_frame;
	_point_y=y-up-battle_board.thickness_frame;
	event_user(0);
	_frame_up_x=_point_x;
	_frame_up_y=_point_y;
	_frame_up_width=left+right+battle_board.thickness_frame*2;
	_frame_up_height=up+battle_board.thickness_frame;
	//左
	_point_x=x-left-battle_board.thickness_frame;
	_point_y=y-up-battle_board.thickness_frame;
	event_user(0);
	...
	_frame_left_width=left+battle_board.thickness_frame;
	_frame_left_height=up+down+battle_board.thickness_frame*2;
	//下
	_point_x=x-left-battle_board.thickness_frame;
	_point_y=y;
	event_user(0);
	...
	_frame_down_width=left+right+battle_board.thickness_frame*2;
	_frame_down_height=down+battle_board.thickness_frame;
	//右
	_point_x=x;
	_point_y=y-up-battle_board.thickness_frame;
	event_user(0);
	...
	_frame_right_width=right+battle_board.thickness_frame;
...
_frame_up_y=_point_y;
_frame_up_width=left+right+battle_board.thickness_frame*2;
_frame_up_height=battle_board.thickness_frame;
//左
_point_x=x-left-battle_board.thickness_frame;
_point_y=y-up-battle_board.thickness_frame;
event_user(0);
_frame_left_x=_point_x;
_frame_left_y=_point_y;
_frame_left_width=battle_board.thickness_frame;
_frame_left_height=up+down+battle_board.thickness_frame*2;
//下
_point_x=x-left-battle_board.thickness_frame;
_point_y=y+down;
...
_frame_down_y=_point_y;
_frame_down_width=left+right+battle_board.thickness_frame*2;
_frame_down_height=battle_board.thickness_frame;
//右
_point_x=x+right;
_point_y=y-up-battle_board.thickness_frame;
event_user(0);
